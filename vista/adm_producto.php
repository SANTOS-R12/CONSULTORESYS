                    ...
                    <div class="card-info">
                        ...
                        <div class="card-body">
                            ...
                            <form id="form-crear-producto">
                                ...
                                <div class="input-group mb-3" title="Ingresar gramos">
                                    <!-- <label for="concentracion">Concentracion</label> -->
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-dumpster"></i></span>
                                    </div>
                                    <input id="concentracion" type="text" class="form-control" placeholder="Ingrese la Duración">
                                </div>
                                ...
                                <div class="input-group mb-3" title="Seleccionar licitacion">
                                    <div class="input-group-prepend">
