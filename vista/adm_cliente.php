                        ...
                        <div class="card-body">
                            ...
                            <form id="form-crear">
                                <div class="form-group">
                                    ...
                                    <input id="nombre"  type="text" class="form-control" placeholder="Ingrese nombre de la empresa">
                                </div>
                                <div class="form-group">
                                    <label for="apellido">Giro de la empresa</label>
                                    <input id="apellido"  type="text" class="form-control" placeholder="Ingrese el giro de la empresa">
                                </div>
                                <div class="form-group">
                                    <label for="dui">NIT</label>
                                    <input id="dui"  type="text" class="form-control" placeholder="Ingrese NIT">
                                </div>
                                <div class="form-group">
                                    <label for="nacimiento">Fecha de ingreso</label>
                                    <input id="nacimiento"  type="date" class="form-control" placeholder="Ingrese fecha de ingreso">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="sexo">Actividad Economica</label>
                                    <input id="sexo"  type="text" class="form-control" placeholder="Ingrese actividad economica">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="card-success">
                        ...
                        <div class="card-body">
                            ...
                            <form id="form-editar">
                                ...
                                <div class="form-group">
                                    <label for="adicional_edit">Observaciones</label>
