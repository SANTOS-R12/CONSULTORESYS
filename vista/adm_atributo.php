                ...
                <div class="modal-content">
                    <div class="card-info">
                        <div class="card-header">
                            <h3 class="card-title">Crear licitacion</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-danger text-center" id="noadd-laboratorio" style="display:none">
                                <span><i class="fas fa-times m-1"></i>La licitacion ya existe</span>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item">
                                            <a href="#laboratorio" class="nav-link active" data-toggle="tab">Licitación</a>
                                        </li>
                                        <li class="nav-item">
