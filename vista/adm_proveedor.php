                ...
                <div class="modal-content">
                    <div class="card-info">
                        <div class="card-header">
                            <h3 class="card-title">Crear facilitador</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-danger text-center" id="noadd-prov" style="display:none">
                                <span><i class="fas fa-times m-1"></i>El facilitador ya existe</span>
                            </div>
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>
                                Gestion Facilitador
                                <button type="button" data-toggle="modal" data-target="#crear_proveedor" class="btn bg-gradient-primary ml-2">Crear facilitador</button>
                            </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Gestion Facilitador</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section>
                <div class="container-fluid">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Buscar Facilitador</h3>
                            <div class="input-group">
                                <input id="buscar_proveedor" placeholder="Ingrese nombre de facilitador" type="text" class="form-control float-left">
