                                ...
                                <div class="row">
                                    <div class="col-7">
                                        ...
                                        <ul class="ml-4 mb-0 fa-ul">
                                            <li class="small"><span class="fa-li"><i ></i></span> Duración: ${lote.concentracion}</li>
                                            <li class="small"><span class="fa-li"><i ></i></span> Adicional: ${lote.adicional}</li>
                                            <li class="small"><span class="fa-li"><i ></i></span> Licitación: ${lote.laboratorio}</li>
                                            <li class="small"><span class="fa-li"><i ></i></span> Tipo: ${lote.tipo}</li>
                                            <li class="small"><span class="fa-li"><i ></i></span> Presentacion: ${lote.presentacion}</li>
                                            <li class="small"><span class="fa-li"><i ></i></span> Vencimiento: ${lote.vencimiento}</li>
                                            <li class="small"><span class="fa-li"><i c></i></span> Facilitador: ${lote.proveedor}</li>
