$(document).ready(function(){
    ...
    function rellenar_laboratorios() {
        ...
        $.post('../controlador/LaboratorioController.php', {funcion}, (response) => {
            ...
            let template = '';
            template += `<option value="0" disabled selected>-- Seleccionar licitación --</option>`;
    ...
    function rellenar_presentaciones() {
        ...
        $.post('../controlador/PresentacionController.php', {funcion}, (response) => {
            ...
            let template = '';
            template += `<option value="0" disabled selected>-- Seleccionar presentacion --</option>`;
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        ...
                                        <ul class="ml-4 mb-0 fa-ul text-muted">
                                            <li class="small"><span class="fa-li"><i class="fas fa-dumpster"></i></span> Duración: ${producto.concentracion}</li>
                                            <li class="small"><span class="fa-li"><i class="fas fa-file-alt"></i></span> Adicional: ${producto.adicional}</li>
                                            <li class="small"><span class="fa-li"><i class="fas fa-shekel-sign"></i></span> Licitación: ${producto.laboratorio}</li>
                                            <li class="small"><span class="fa-li"><i class="fas fa-toolbox"></i></span> Tipo: ${producto.tipo}</li>
