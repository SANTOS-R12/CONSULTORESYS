            ...
            proveedores.forEach(proveedor => {
                ...
                <div class="card bg-light">
                  <div class="card-header text-muted border-bottom-0">
                    <h1 class="badge badge-success">Facilitador</h1>
                  </div>
                  ...
                  <div class="card-footer">
                    <div class="text-right">
                      <button type="button" data-toggle="modal" data-target="#cambio_logo" class="btn btn-sm btn-success avatar" title="Editar logo">
                        <i class="fas fa-image"></i>
                      </button>
                      <button type="button" data-toggle="modal" data-target="#crear_proveedor" class="btn btn-sm btn-info editar" title="Editar Facilitador">
                        <i class="fas fa-pencil-alt"></i>
                      </button>
                      <button class="btn btn-sm btn-danger borrar" title="Borrar Facilitador">
            ...
            if (result.value) {
                $.post('../controlador/ProveedorController.php', {id, funcion}, (response) => {
                    ...
                    if (response == 'borrado') {
                        swalWithBootstrapButtons.fire(
                            'Eliminado!',
                            'El facilitador '+nombre+' fue borrado.',
                            'success'
                        )
                        buscar_prov();
                    }else{
                        swalWithBootstrapButtons.fire(
                            'No se pudo borrar!',
                            'El facilitador '+nombre+' no fue borrado porque esta siendo utilizado en un lote.',
                            'error'
                        )
                    }
                });
