                ...
                <div class="card bg-light">
                    ...
                    <div class="row">
                      <div class="col-7">
                        ...
                        <ul class="ml-4 mb-0 fa-ul text-muted">
                          <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> NIT: ${cliente.dui}</li>
                          <li class="small"><span class="fa-li"><i class="fas fa-user-alt"></i></span> Fecha Ingreso #: ${cliente.edad}</li>
                          ...
                          <li class="small"><span class="fa-li"><i class="fas fa-user-alt"></i></span> Actividad Economica: ${cliente.sexo}</li>
                          <li class="small"><span class="fa-li"><i class="far fa-clipboard"></i></span> Adicional: ${cliente.adicional}</li>
                        </ul>
                      </div>
                  ...
                  <div class="card-footer">
                    <div class="text-right">
                      <button type="button" data-toggle="modal" data-target="#editar_cliente" class="btn btn-sm btn-info editar" title="Editar Cliente">
